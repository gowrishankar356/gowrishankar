        ...
        <div>
          <div className={styles.job_item}>
            ...
            <div className={styles.job_summary}>
              ...
              <ul>
                <li>
                  Developed a client-server application (Pringle NOC) in a team
                  of 5 engineers to track and manage robots' locations and
                  statuses in real-time using Next.js and TypeScript to ensure a
                  responsive user interface.
                </li>
                <li>
                  Integrated the Google Maps API and marker clustering for peak
                  map efficiency and to reduce 30% of page load times.
                </li>
                <li>
                  Engineered over 50 custom responsive UI components for the
                  company's web applications, employing Next.js, TypeScript, and
                  Storybook. Elevated user satisfaction by providing a seamless
                  UI experience to customers.
                </li>
                <li>
                ...
                <li>
                  ...
                  generation for microservice’s Table script, CRUD scripts, BO,
                  DAO, and Controller files using ASP.NET, C#, and SQL with 99%
                  correctness.
                </li>
                <li>
                ...
                <li>
                  Streamlined Agile Software Development processes by utilizing
                  Trello as a Scrum board, resulting in a 40% increase in team
                  collaboration and a 15% reduction in project delivery time.
                </li>
              </ul>
              <h3>Skills acquired: </h3>
              <p>
                · C# · ASP.NET(MVC) · Microsoft SQL Server · ReactJS · NextJS ·
                TypeScript <br></br>· Visual Studio · BitBucket · Agile Software
                Methodologies{" "}
              </p>
            </div>
          </div>
          <div className={styles.job_item}>
            ...
            <div className={styles.job_summary}>
              <p>
                ...
                concentrating in Payroll, Core HR, Self-Service, and Oracle Time
                and Labor.
              </p>
              ...
              <ul>
                <li>
                  Implemented and demonstrated three full-time Oracle Fusion ERP
                  Systems which include Core HR, Payroll, Absence Management,
                  Self-Service and Time and Labor modules which include
                  retrieving employee salary details and leave data to calculate
                  monthly salary, Indemnity, Social Insurance, deductions etc
                  using SQL & PL/SQL.
                </li>
                <li>
                ...
                <li>
                  ...
                  highlight the employee data regarding implemented modules for
                  budgeting and reconciliation purposes using SQL & PL/SQL.
                </li>
